...
Level.create(name: 'Level One', targetString: '001001', css: 'level-one', goal: 40)
# https://apod.nasa.gov/apod/astropix.html
Level.create(name: 'Level Two', targetString: '001132', css: 'level-two', goal: 40)
#https://www.jpl.nasa.gov/spaceimages/details.php?id=PIA14872
Level.create(name: 'Level Three', targetString: '000133122', css: 'level-three', goal: 50)

Level.create(name: 'Boss Fight!', targetString: '222333', css: 'boss-fight', goal: 100)
